...
Properties {
    ...
    _FrontTex1("2 Front (+Z)", 2D) = "white" {}
    _BackTex1("2 Back (-Z)", 2D) = "white" {}
    _LeftTex1("2 Left (+X)", 2D) = "white" {}
    _RightTex1("2 Right (-X)", 2D) = "white" {}
    _UpTex1("2 Up (+Y)", 2D) = "white" {}
    _DownTex1("2 Down (-Y)", 2D) = "white" {}
